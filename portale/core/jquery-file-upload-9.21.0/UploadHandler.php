...
class UploadHandler
{
    ...
    public function __construct($options = null, $initialize = true, $error_messages = null) {
      ...
      // echo dirname($this->get_server_var('DOCUMENT_ROOT')).'/html/arx_portale/clini/portale/uploads/';
      // echo dirname($this->get_server_var('SERVER_NAME')).'/html/arx_portale/clini/portale/uploads/';
      // die;

        $this->response = array();
        $this->options = array(
            'script_url' => $this->get_full_url().'/'.$this->basename($this->get_server_var('SCRIPT_NAME')),
            'upload_dir' => dirname($this->get_server_var('DOCUMENT_ROOT')).'/html/arx_portale/clini/portale/uploads/',
            'upload_url' => dirname($this->get_server_var('SERVER_NAME')).'/html/arx_portale/clini/portale/uploads/',
